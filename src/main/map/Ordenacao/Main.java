...
//
//        eventos.adicionarEvento(LocalDate.of(2025, Month.JULY, 25), "Evento 1", " Atração 1");
//        eventos.adicionarEvento(LocalDate.of(2025,7, 9), "Evento 2", " Atração 2");
//        eventos.adicionarEvento(LocalDate.of(2000, Month.JANUARY, 10), "Evento 3", " Atração 3");
//        eventos.adicionarEvento(LocalDate.of(2025, Month.AUGUST, 1), "Evento 4", " Atração 4");
//
//
//        eventos.exibirAgenda();
//
